...
export default function SignUp() {
  ...
  return (
    <div className="flex-grow">
      <form onSubmit={handleSignUp} className="flex flex-col min-w-64 max-w-64 md:max-w-sm mx-auto mt-8 p-4 bg-[#0d1b35] rounded-lg">
        <h1 className="text-2xl font-medium mb-4">Sign Up</h1>
        <p className="text-sm text text-white">Already have an account?</p>
